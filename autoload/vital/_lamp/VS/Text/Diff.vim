...
execute join(['function! vital#_lamp#VS#Text#Diff#import() abort', printf("return map({'is_lua_enabled': '', 'compute': ''}, \"vital#_lamp#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
"
" is_lua_enabled
